...
-- For existing DBs, use migrate_001_job_board.sql instead of re-running this file.
...
INSERT INTO accounts (company_id, name, type, hq_country, website, description, tier, metadata, job_board_provider, job_board_slug) VALUES
...
-- Stripe: payments infrastructure; Issuing + Treasury create direct product-surface overlap
(1, 'Stripe', 'partner', 'US', 'https://stripe.com',
  ...
  2, '{"focus":"payments infrastructure","products":["Treasury","Issuing","Financial Connections"]}',
  'greenhouse', 'stripe');